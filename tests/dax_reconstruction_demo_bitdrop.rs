...
fn dax_multi_frame_reconstruction_demo_bitdrop() -> Result<()> {
    ...
    println!("Fold (compress) mean:         {:.3} ms Â± {:.3} ms", fold_mean_ms, fold_stddev_ms);
    println!("Unfold (reconstruct) mean:    {:.3} ms Â± {:.3} ms", unfold_mean_ms, unfold_stddev_ms);
    ...
    println!("Fold time (stripped mean):   {:.3} ms Â± {:.3} ms", fold_stripped_mean_ms, fold_stripped_stddev_ms);
    println!("------------------------------------------------------------");

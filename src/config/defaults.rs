...
pub fn default_policy() -> MemoryPolicy {
    MemoryPolicy {
        // ---------------------------------------------------------
        // DECAY POLICY â€” tuned for stable short-term â†’ long-term flow
        // ---------------------------------------------------------
        decay: DecayPolicy {
            ...
            // Confidence floor raised slightly to prevent â€œdead cellsâ€
            // and keep low-signal nodes available for future reinforcement.
            confidence_floor: 0.08,
        },

        // ---------------------------------------------------------
        // CONFLICT POLICY â€” tuned for multi-layer fusion
        // ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // COMPRESSION POLICY â€” tuned for your grid + heatmap engine
        // ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
        // CROSS-CONNECT POLICY â€” tuned for multi-layer reasoning
        // ---------------------------------------------------------

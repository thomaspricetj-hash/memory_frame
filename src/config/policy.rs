...
/// Supports loading, validating, updating, and hot‑reloading.
...
impl PolicyManager {
    ...
    pub fn load_from_json(json: &str) -> anyhow::Result<Self> {
        ...
        manager.validate()?;     // auto‑validate
        Ok(manager)
    }

    /// Replace the active policy at runtime.
    /// Useful for hot‑reload or adaptive tuning.
    ...
    pub fn validate(&self) -> anyhow::Result<()> {
        ...
        // -------------------------
        // Cross‑connect policy validation
        // -------------------------
